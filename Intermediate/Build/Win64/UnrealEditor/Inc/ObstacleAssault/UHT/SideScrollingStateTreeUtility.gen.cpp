...
OBSTACLEASSAULT_API UScriptStruct* Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData();
OBSTACLEASSAULT_API UScriptStruct* Z_Construct_UScriptStruct_FStateTreeGetPlayerTask();
...
class UScriptStruct* FStateTreeGetPlayerInstanceData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerInstanceData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData, (UObject*)Z_Construct_UPackage__Script_ObstacleAssault(), TEXT("StateTreeGetPlayerInstanceData"));
	}
...
class UScriptStruct* FStateTreeGetPlayerTask::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerTask.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStateTreeGetPlayerTask, (UObject*)Z_Construct_UPackage__Script_ObstacleAssault(), TEXT("StateTreeGetPlayerTask"));
	}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_Sav_Documents_Unreal_Projects_Udemy_Courses_ObstacleAssault_Source_ObstacleAssault_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_ObstacleAssault_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FStateTreeGetPlayerInstanceData::StaticStruct, Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData_Statics::NewStructOps, TEXT("StateTreeGetPlayerInstanceData"), &Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerInstanceData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateTreeGetPlayerInstanceData), 2714605867U) },
		{ FStateTreeGetPlayerTask::StaticStruct, Z_Construct_UScriptStruct_FStateTreeGetPlayerTask_Statics::NewStructOps, TEXT("StateTreeGetPlayerTask"), &Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerTask, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateTreeGetPlayerTask), 866233911U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Sav_Documents_Unreal_Projects_Udemy_Courses_ObstacleAssault_Source_ObstacleAssault_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_ObstacleAssault_3396429665(TEXT("/Script/ObstacleAssault"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Users_Sav_Documents_Unreal_Projects_Udemy_Courses_ObstacleAssault_Source_ObstacleAssault_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_ObstacleAssault_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Sav_Documents_Unreal_Projects_Udemy_Courses_ObstacleAssault_Source_ObstacleAssault_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_ObstacleAssault_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
